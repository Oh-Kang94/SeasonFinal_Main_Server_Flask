...
class User(db.Model):
    ...
    bankaccount = db.Column(db.String(45), nullable=True, default=None)
...
class Balance(db.Model):
    ...
    userid = db.Column(db.String(45), db.ForeignKey('user.id'), nullable=True)
...
class Auction(db.Model):
    ...
    seller_id = db.Column(db.String(45), db.ForeignKey('user.id'), nullable=True)
    ...
    view = db.Column(db.String(45), nullable=True)
    ...
    issuccessed = db.Column(db.Boolean, nullable=True)
    # 관계성 만들기
...
class Bidded(db.Model):
    ...
    auctionid = db.Column(db.String(45), db.ForeignKey('auction.auctionid'), nullable=True)
